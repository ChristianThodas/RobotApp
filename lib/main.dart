      ...
      child: Column(
        ...
        children: [
          ...
          if (iconsVisible) ...[
            ...
            const SizedBox(height: 8),
            if (isExpanded) ...[
              Container(height: 1, width: 200, color: const Color(0xFF585858)),
              const SizedBox(height: 8),
              const Padding(
...
class _RobotControlState extends State<RobotControl> {
  ...
  SidebarScreen? selectedScreen; // default
          ...
          children: [
            ...
            Positioned(
              ...
              child: InkWell(
                ...
                child: Image.asset('assets/icons/Dashboard.png', height: 28),
              ),
            ),
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Image.asset('assets/icons/MapSelected.png', height: 32),
            ...
            // ⭐ SHARED BOTTOM BAR (replaces old bottom bar)
            BottomBar(
...
class _CamControlState extends State<CamControl> {
  ...
  void _zoomIn() {
    setState(() {
      _cameraZoom += 0.1;
      if (_cameraZoom > 5.0) _cameraZoom = 5.0;
    });
  }
  ...
  void _zoomOut() {
    setState(() {
      _cameraZoom -= 0.1;
      if (_cameraZoom < 1.0) _cameraZoom = 1.0;
    });
  }
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 16),
                    Image.asset('assets/icons/CamSelected.png', height: 32),
                  ],
                ),
              ),
            ),
  ...
  Widget _buildFirstBox() {
    return Container(
      ...
      child: Row(
        ...
        children: [_digitColumn(1.08, 'VOLTAGE'), _digitColumn(80, 'RSSi')],
      ),
    );
  }
